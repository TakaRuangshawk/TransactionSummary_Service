...
namespace TransactionSummary
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Read the year and month in yyyyMM format from App.config
            string yearMonthStr = ConfigurationManager.AppSettings["YearMonth"]; // e.g., "202408"
            ...
            // Convert the dates back to string if needed
            ...
            string trxTypeStr = ConfigurationManager.AppSettings["TransactionType"];
            ...
            try
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string tableName = $"transaction_summary_{DateTime.Now.ToString("yyyyMM")}_{trxTypeStr}";
